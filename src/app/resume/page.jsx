                ...
                <ProfileBox data-aos="fade-down">
                    <IntroduceBox>
                        ...
                        <IntroText>
                            ...
                            많은 사람들의 생각과 고민을 서비스로 만드는 것에 대해 흥미를 느껴 개발자가 되었습니다.{' '}
                            <br />
                        ...
                        <ProjectContents>
                            <ContentList data-aos="fade-right">
                                ...
                                <li>
                                    ...
                                    <span>
                                        반려동물을 키우는 사람들이, 반려동물의 피부 질환이 발생한 경우, 초기에 증상
                                        유무를 빠르게 판단해 신속한 병원 내원 및 진료를 할 수 있도록 하기 위해 서비스
                                        개발
                                    </span>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span>
                                        Front-end: TypeScript, React, React-Query, Socket.io, Jotai, Styled-Components,
                                        MUI <br /> Back-end: Node.js, Express, MySql, Prisma
                                    </span>
                                </li>
                            </ContentList>
                        ...
                        <ProjectContents>
                            <ContentList data-aos="fade-right">
                                ...
                                <li>
                                    <span className="content-title">설명</span>
                                    <span>
                                        환경 문제에 대한 심각성을 알아보고, 그룹별 활동을 통해 재미있게 환경보호 활동에
                                        동참하는 서비스 입니다.
                                    </span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <span className="content-title">기술스택</span>
                                    <span>
                                        Front-end: React, Recoil, Axios, Styled-Components, MUI <br /> Back-end:
                        ...
                        <ProjectContents>
                            <ContentList data-aos="fade-right">
                                ...
                                <li>
                                    <span className="content-title">기술스택</span>
                                    <span>
                                        Front-end: Next.js, Recoil, GraphQL, Emotion, Ant-Design <br /> Back-end:
                                        Node.js, Nest.js, SQL, MongoDB
                                    </span>
                                </li>
                            </ContentList>
                    ...
                    <SkillContainer data-aos="fade-up">
                        ...
                        <ContentList>
                            ...
                            <li>
                                ...
                                <span>
                                    ES6를 포함한 자바스크립트 문법에 익숙하며 현재는 자바스크립트 동작원리에 대해 조금
                                    더 깊게 공부하는 중입니다.
                                </span>
                            </li>
                            <li>
                                ...
                                <span>
                                    -함수형 컴포넌트에 익숙하며 컴포넌트를 분리하여 디자인하는데 익숙합니다. 반복되는
                                    로직을 분리하여 사용하기 위해 Custom Hook을 제작하여 사용하며 생명주기를 다루는데
                                    익숙합니다.
                                    <br />
                                    <br />
                            ...
                            <li>
                                ...
                                <span>
                                    TypeScript를 통한 리액트 코딩에 익숙하며 문법을 잘 활용하여 적절한 타입을
                                    사용합니다.
                                </span>
                            </li>
                            <li>
                                <span className="content-title">Flutter</span>
                                <span>플러터를 활용해 하이브리드 앱 개발이 가능합니다.</span>
                            </li>
                            <li>
                                <span className="content-title">GraphQL</span>
                                <span>
                                    REST-API와 GraphQL의 장단점을 구분하여 상황에 맞는 데이터 통신을 할 수 있습니다.
                                </span>
                            </li>
                            <li>
                                <span className="content-title">Next.js</span>
                                <span>
                                    Next12 버전으로 공부를 해왔었는데 현재 Next13 버전도 학습중에 있습니다. 서버 사이드
                                    렌더링을 구현 할 수 있습니다.
                                </span>
                            </li>
                            <li>
                                ...
                                <span>
                                    Recoil을 통한 전역 상태관리를 할 수 있으며 현재 Redux / Zustand도 지속적으로
                                    학습중입니다.
                                </span>
                            </li>
                        </ContentList>
                    ...
                    <SkillContainer data-aos="fade-up">
                        ...
                        <ContentList>
                            ...
                            <li>
                                ...
                                <span>
                                    SQL을 활용하여 테이블 관계를 형성할 수 있으며, 상세문법을 지속적으로 학습중에
                                    있습니다.
                                </span>
                            </li>
                        </ContentList>
                    ...
                    <EducationContainer data-aos="fade-up">
                        <ContentList>
                            <li>
                                ...
                                <span>
                                    1. 리액트와 Node.js를 통한 웹개발의 전반적인 내용 학습 / 2. SQL, 파이썬을 활용한
                                    데이터 분석 / 3. 머신러닝, 딥러닝, AI활용 <br /> 각 파트가 마칠 때마다 팀 프로젝트를
                                    시행하여 총 3회 팀 프로젝트를 경험합니다.
                                </span>
                            </li>
                            <li>
                                <span className="content-title">
                                ...
                                <span>
                                    매 주 기업과제를 해결하며 리액트의 최적화 방법 등의 심화적인 내용을 학습 하였습니다.
                                </span>
                            </li>
                            <li>
                                <span className="content-title">
